...
// Supabase project URL and publishable key are set to the project's
// values used elsewhere in this repo.
// =============================================================
(function () {
  'use strict';
  const SUPABASE_URL = 'https://yifethequioqnvbgtvsb.supabase.co';
  const SUPABASE_KEY = 'sb_publishable_mwtqwX9t6FWlGylOWASPig_FPNAeFOJ';
